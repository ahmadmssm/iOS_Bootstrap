...
//import Foundation
//
//open class GsonDecoder: JSONDecoder {
//
...
//            guard let int = try Int(String.from(data: data))
//                  else { throw KeyedCodableError.stringParseFailed }
//            return int as! T
//        }
//        else if let type = T.self as? LosslessStringConvertible.Type {
//            guard let lossless = try type.init(String.from(data: data))
//                  else { throw KeyedCodableError.stringParseFailed }
