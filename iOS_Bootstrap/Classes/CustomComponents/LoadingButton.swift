...
//  LoadingButton
//
//  Created by Romilson Nunes on 06/06/14 & edited by Ahmad mahmoud on 30/09/2018.
//  Copyright (c) 2014 Romilson Nunes. All rights reserved.
//
// Ref : https://github.com/souzainf3/RNLoadingButton-Swift
...
open class LoadingButton: UIButton {
    ...
    public func setActivityIndicatorAlignment(_ alignment: ActivityIndicatorAlignment) {
    ...
    @objc func activityIndicatorTapped(sender:AnyObject) {
    ...
    func setupActivityIndicator() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(LoadingButton.activityIndicatorTapped(sender:)))
